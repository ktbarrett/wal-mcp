...
async def test_load_via_wal_exposes_signals(waveform_file):
...
@pytest.mark.asyncio
async def test_load_invalid_path_surfaces_wal_error():
...
@pytest.mark.asyncio
async def test_execute_wal_no_waveform_loaded():
...
@pytest.mark.asyncio
@pytest.mark.parametrize("waveform_file", WAVEFORM_FILES)
async def test_state_persists_across_calls(waveform_file):
...
@pytest.mark.asyncio
@pytest.mark.parametrize("waveform_file", WAVEFORM_FILES)
async def test_unload_via_wal(waveform_file):
...
@pytest.mark.asyncio
async def test_reset_evaluator_clears_state():
